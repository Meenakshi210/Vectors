...
\hhline{|-------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \gnumericPB{\centering}\gnumbox{Altitude $AP$}}}}
...
\hhline{|-------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \addtolength{\gnumericMultiRowLength}{\tabcolsep}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{Altitude $BQ$}}}}
...
\hhline{|-------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \addtolength{\gnumericMultiRowLength}{\tabcolsep}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{Altitude $CR$}}}}
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{$\myvec{-4.43\\-0.43}$}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
...
\hhline{|-------|}
	...
	\gnumericColD+%
	\tabcolsep*2*1}|}%
	{\gnumericPB{\centering}\gnumbox{(O-((B+C)/2).(B-C)=0}}
	&\multicolumn{3}{p{	\gnumericColE+%
	\gnumericColF+%
	\gnumericColG+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\centering}\gnumbox{Verified}}
\\
\hhline{|--|--|---|}
\end{tabular}
